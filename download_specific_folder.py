"""
特定のGoogle DriveフォルダからCSVファイルをダウンロード
"""
import os
import pickle
import io
...
FOLDER_ID = '1ZSbnuyV3w718eA1lF-qyuDUPxJbYGTws'  # ユーザー指定のフォルダ
OUTPUT_DIR = './data/raw'
...
if __name__ == '__main__':
    try:
        ...
        files = download_files_from_folder(service, FOLDER_ID, OUTPUT_DIR)
