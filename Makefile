.PHONY: help clean download merge analyze-seo analyze-search-console export-dify upload commit all
...
# 全ての処理を実行
all: download merge analyze-seo analyze-search-console export-dify upload commit
	@echo ""
	@echo "=========================================="
	@echo "✅ 全ての処理が完了しました！"
	@echo "=========================================="
...
download:
	@echo "[1/7] Google Driveからデータをダウンロード中..."
...
commit:
	...
	@git add data/analysis/*.csv data/analysis/*.txt data/dify_export/*.md 2>/dev/null || true
